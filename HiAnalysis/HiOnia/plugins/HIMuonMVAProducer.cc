...
void pat::HIMuonMVAProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<edm::FileInPath>("file_isoCorr", edm::FileInPath("HeavyIonsAnalysis/Configuration/data/lepton_spectra_train_weights_Run3_2023_PbPb.json.gz"))->setComment("Path to isolation rho correction");
